...
def parse_arg():
    ...
    parser.add_argument('--model', type=str, default='/scratch365/yding4/EntQA/data/retriever.pt',
                        help='model path')
    parser.add_argument('--pretrained_path', type=str, default='/scratch365/yding4/EntQA/data/blink_model/models/',
    ...
    parser.add_argument('--data_dir', type=str, default='/scratch365/yding4/EntQA/data/retriever_input/',
                        help='the  data directory')
    parser.add_argument('--kb_dir', type=str, default='/scratch365/yding4/EntQA/data/kb',
                        help='the knowledge base directory')
    parser.add_argument('--out_dir', type=str, default='/scratch365/yding4/EntQA/data/reader_input',
    ...
    parser.add_argument('--cands_embeds_path', type=str,default='/scratch365/yding4/EntQA/data/candidate_embeds.npy',
...
def load_entities(kb_dir='/scratch365/yding4/EntQA/data/kb'):
        entities = []
